...
function updateUILanguage(lang) {
    ...
    document.querySelector('label[for="txtFormat"], label:has(#txtFormat)').textContent = texts.textFormat;
    document.querySelector('label[for="htmlFormat"], label:has(#htmlFormat)').textContent = texts.htmlFormat;
